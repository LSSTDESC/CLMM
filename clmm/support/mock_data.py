...
def generate_galaxy_catalog(cluster_m, cluster_z, cluster_c, cosmo, zsrc, cluster_ra=0., cluster_dec=0.,
    ...
    if validate_input:
        ...
        validate_argument(locals(), 'cluster_ra', float, argmin=-90, argmax=90, eqmin=True, eqmax=True)
        validate_argument(locals(), 'cluster_dec', float, argmin=-360., argmax=360., eqmin=True, eqmax=True)
