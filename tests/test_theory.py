...
def test_shear_convergence_unittests(modeling_data):
    ...
    assert_allclose(mod.eval_reduced_tangential_shear(*profile_pars, 'schrabback', beta_s_mean, beta_s_square_mean), (1. + (beta_s_square_mean / (beta_s_mean * beta_s_mean) - 1.) * beta_s_mean * kappa_inf) * (beta_s_mean * gammat_inf / (1. - beta_s_mean * kappa_inf)), 1.0e-10)
