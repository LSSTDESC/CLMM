...
def test_profiles(modeling_data):
    ...
    cosmo_pars = cfg['cosmo_pars']
    for mod in (modccl, modct, modnc):
        m = mod.Modeling()
        m.set_cosmo(mod.Cosmology(H0=cosmo_pars['H0'], Omega_dm0=cosmo_pars['Om0']-cosmo_pars['Ob0'], Omega_b0=cosmo_pars['Ob0']))
...
def test_shear_convergence_unittests(modeling_data):
    ...
    for mod in (modccl, modct, modnc):
        m = mod.Modeling()
        m.set_cosmo(mod.Cosmology(H0=cosmo_pars['H0'], Omega_dm0=cosmo_pars['Om0']-cosmo_pars['Ob0'],
                                  Omega_b0=cosmo_pars['Ob0']))
